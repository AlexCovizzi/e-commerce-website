...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`VoteView` (`book_isbn` INT, `title` INT, `name` INT, `surname` INT, `thumb_up` INT, `comment` INT);
...
SELECT V.book_isbn, B.title, U.name, U.surname, V.thumb_up, V.comment
FROM Vote as V
